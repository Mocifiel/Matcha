...
exp_name="matcha-sydney-1"  # experimental name (e.g., Evan/Guy/Aria)

# if the packages not installed in the docker, you can install them here
extra_env_setup_cmd="pip install torchvision==0.15.2 torchaudio==2.0.2; pip install --user -e ." # or extra_env_setup_cmd=""
...
python -u third_party/Submitter/utils/amlt_submit.py \
  ...
  --run-cmd "python codes/train.py -opt ../experiments/sydney_multiflow.yml" \
